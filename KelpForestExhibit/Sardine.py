...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Sardine.x3d',name='identifier'),
        ...
        Transform(rotation=(1,0,0,-1.57),scale=(.3,.25,.25),
          ...
          Shape(
            appearance=Appearance(
              ...
              texture=ImageTexture(url=["SardineScalesPatch.jpg","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineScalesPatch.jpg"])),
...
print('Self-test diagnostics for Sardine.py:')
...
print("python Sardine.py load and self-test diagnostics complete.")
