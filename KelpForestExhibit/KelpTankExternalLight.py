...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTankExternalLight.x3d',name='identifier'),
...
print('Self-test diagnostics for KelpTankExternalLight.py:')
...
print("python KelpTankExternalLight.py load and self-test diagnostics complete.")
