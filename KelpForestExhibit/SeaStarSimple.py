...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='20 October 2019',name='modified'),
    meta(content='https://x3dgraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SeaStarSimple.x3d',name='identifier'),
...
print('Self-test diagnostics for SeaStarSimple.py:')
...
print("python SeaStarSimple.py load and self-test diagnostics complete.")
