...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("SharkLucyLocale.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Lucy Shark with animation to traverse the tank") \
     .setName("description") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    .addChild(Transform() \
     ...
     .addChild(Inline() \
      .setUrl(["SharkLucy.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SharkLucy.x3d","SharkLucy.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SharkLucy.wrl"]) \
     ) \
     .addChild(Group() \
      .addChild(TimeSensor() \
       .setDEF("SHARK1_CLOCK") \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/KelpForestExhibit//SharkLucyLocale_RoundTrip.x3d")
