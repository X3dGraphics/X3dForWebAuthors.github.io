...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Fish.x3d',name='identifier'),
          ...
          Transform(DEF='Fish1',scale=(0.1,0.1,0.1),
            ...
            Shape(
              appearance=Appearance(DEF='FishAppear',
                ...
                texture=ImageTexture(DEF='FishJPG',url=["Fish2Patch.jpg","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Fish2Patch.jpg"])),
