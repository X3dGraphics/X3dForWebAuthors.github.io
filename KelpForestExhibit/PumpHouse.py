...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='PumpHouse.x3d',name='title'),
    meta(content='Positive-displacement cylinder pump to emulate breakers surge, designed and built by David Packard.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/PumpHouse.x3d',name='identifier'),
...
print('Self-test diagnostics for PumpHouse.py:')
...
print("python PumpHouse.py load and self-test diagnostics complete.")
