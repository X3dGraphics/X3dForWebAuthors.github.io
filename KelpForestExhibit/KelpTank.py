...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTank.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Collision(enabled=False,
      ...
      Transform(
        children=[
        Inline(url=["KelpTankWaterSurface.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTankWaterSurface.x3d","KelpTankWaterSurface.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTankWaterSurface.wrl"])]),
      Transform(
        children=[
        Inline(url=["KelpTankExternalLights.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTankExternalLights.x3d","KelpTankExternalLights.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpTankExternalLights.wrl"])]),
      Transform(rotation=(0.0,1.0,0.0,1.5785398),translation=(-10.35,1.0,-0.5),
        children=[
        Inline(url=["PumpHouse.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/PumpHouse.x3d","PumpHouse.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/PumpHouse.wrl"])]),
      Shape(
