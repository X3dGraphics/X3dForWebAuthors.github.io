...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/BlueRockFish.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      ProtoInstance(DEF='BlueRockfish',name='CircleFishLod',
        fieldValue=[
        fieldValue(name='skinTextureUrl',value=["blueRockfishPatch.jpg","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/blueRockfishPatch.jpg"]),
...
print('Self-test diagnostics for BlueRockFish.py:')
...
print("python BlueRockFish.py load and self-test diagnostics complete.")
