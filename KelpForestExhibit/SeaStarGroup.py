...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://x3dgraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SeaStarGroup.x3d',name='identifier'),
...
print('Self-test diagnostics for SeaStarGroup.py:')
...
print("python SeaStarGroup.py load and self-test diagnostics complete.")
