...
X3D0 = X3D() \
   ...
   .setHead(head() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineWagging.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/KelpForestExhibit//SardineWagging_RoundTrip.x3d")
