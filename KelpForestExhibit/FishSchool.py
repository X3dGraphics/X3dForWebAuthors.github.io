...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/FishSchool.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Sound(location=(0,0.1,0),maxBack=50,maxFront=50,minBack=50,minFront=50,
      source=AudioClip(description='Sound for Fish',loop=True,url=["Sound2.wav","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Sound2.wav"])),
    ...
    Transform(DEF='Fish0',translation=(-5.0,0.0,0.0),
      ...
      Inline(DEF='FishIN',url=["Fish.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Fish.x3d","Fish.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/Fish.wrl"])]),
    ...
    Script(DEF='BoidScript',directOutput=True,mustEvaluate=True,url=["FishSchoolCode/Demo.class","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/FishSchoolCode/Demo.class"],
      field=[
...
print('Self-test diagnostics for FishSchool.py:')
...
print("python FishSchool.py load and self-test diagnostics complete.")
