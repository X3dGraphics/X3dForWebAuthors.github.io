...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("PumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Positive-displacement cylinder pump to emulate breakers surge, designed and built by David Packard.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/KelpForestExhibit//PumpHouse_RoundTrip.x3d")
