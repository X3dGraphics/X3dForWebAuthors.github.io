...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/IntroductionMessage.x3d',name='identifier'),
...
print('Self-test diagnostics for IntroductionMessage.py:')
...
print("python IntroductionMessage.py load and self-test diagnostics complete.")
