...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SeaStarHighResolutionExample.x3d',name='identifier'),
...
print('Self-test diagnostics for SeaStarHighResolutionExample.py:')
...
print("python SeaStarHighResolutionExample.py load and self-test diagnostics complete.")
