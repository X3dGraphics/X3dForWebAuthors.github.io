...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpPrototype.x3d',name='identifier'),
              ...
              Transform(DEF='blade_X1',rotation=(0,1,0,1.0),translation=(0,12,0),
                ...
                Transform(DEF='bladeRotateZ',rotation=(0,0,1,-1.2),
                  ...
                  Transform(DEF='BLADE',center=(-0.5,0,0),translation=(1,0,0),
                    children=[
                    Inline(DEF='bulb',url=["KelpBulb.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpBulb.x3d","KelpBulb.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/KelpBulb.wrl"])])])]),
...
print('Self-test diagnostics for KelpPrototype.py:')
...
print("python KelpPrototype.py load and self-test diagnostics complete.")
