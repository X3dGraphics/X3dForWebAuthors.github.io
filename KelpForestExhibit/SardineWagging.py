...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineWagging.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='SardineWagging.x3d'),
    Group(
      children=[
...
print('Self-test diagnostics for SardineWagging.py:')
...
print("python SardineWagging.py load and self-test diagnostics complete.")
