...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SeaStarPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for SeaStarPrototype.py:')
...
print("python SeaStarPrototype.py load and self-test diagnostics complete.")
