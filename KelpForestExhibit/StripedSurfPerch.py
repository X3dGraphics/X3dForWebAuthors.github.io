...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://x3dgraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/StripedSurfPerch.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoInstance(DEF='StripedSurfPerch',name='CircleFishLod',
      fieldValue=[
      fieldValue(name='skinTextureUrl',value=["StripedSurfPerchPatch.jpg","https://x3dgraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/StripedSurfPerchPatch.jpg"]),
...
print('Self-test diagnostics for StripedSurfPerch.py:')
...
print("python StripedSurfPerch.py load and self-test diagnostics complete.")
