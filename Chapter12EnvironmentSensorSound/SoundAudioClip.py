...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/SoundAudioClip.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Sound(DEF='Audible',location=(0,1.6,0),maxBack=20,maxFront=100,minBack=10,minFront=10,priority=1,
      source=AudioClip(DEF='WaterSounds',description='Running Water',loop=True,url=["aqua.wav","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/aqua.wav"])),
...
print('Self-test diagnostics for SoundAudioClip.py:')
...
print("python SoundAudioClip.py load and self-test diagnostics complete.")
