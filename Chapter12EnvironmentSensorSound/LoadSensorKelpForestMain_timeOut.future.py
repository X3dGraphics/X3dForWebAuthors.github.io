...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("LoadSensorKelpForestMain_timeOut.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/LoadSensorKelpForestMain_timeOut.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
     ...
     .addChild(Collision() \
      ...
      .setProxy(Transform() \
       ...
       .addChild(Transform() \
        ...
        .addChild(Inline() \
         .setDEF("LoadSardine") \
         .setUrl(["../KelpForestExhibit/SardineSchool.wrz","SardineSchool/SardineSchool.wrz","../KelpForestExhibit/SardineSchool.x3d","../KelpForestExhibit/SardineSchool/SardineSchool.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.x3d","../KelpForestExhibit/SardineSchool.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/SardineSchool.wrl"]) \
        ) \
       ) \
       .addChild(Transform() \
        .setDEF("K2_FLOOR") \
...
# totalDuration is a computed output 
    ...
    .addChild(ROUTE() \
     ...
     .setFromNode("LoadMonitor") \
     .setToField("progress") \
     .setToNode("Display") \
    ) \
   ) \

X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound//LoadSensorKelpForestMain_timeOut_RoundTrip.x3d")
