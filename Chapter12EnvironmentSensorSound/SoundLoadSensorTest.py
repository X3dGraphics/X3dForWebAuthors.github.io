...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    ...
    Sound(DEF='SomeSound',location=(0,1.6,0),maxBack=100,maxFront=100,minBack=10,minFront=10,
      source=AudioClip(DEF='WaterSounds',description='Running Water',url=["aqua.wav","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/aqua.wav"])),
...
print('Self-test diagnostics for SoundLoadSensorTest.py:')
...
print("python SoundLoadSensorTest.py load and self-test diagnostics complete.")
