...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/ProximitySensorExample.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='CnvText',url=["ProximitySensorScriptConvertText.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/ProximitySensorScriptConvertText.js"],
      field=[
...
print('Self-test diagnostics for ProximitySensorExample.py:')
...
print("python ProximitySensorExample.py load and self-test diagnostics complete.")
