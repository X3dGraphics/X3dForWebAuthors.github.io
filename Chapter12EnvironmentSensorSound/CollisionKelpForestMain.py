...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/CollisionKelpForestMain.x3d',name='identifier'),
...
print('Self-test diagnostics for CollisionKelpForestMain.py:')
...
print("python CollisionKelpForestMain.py load and self-test diagnostics complete.")
