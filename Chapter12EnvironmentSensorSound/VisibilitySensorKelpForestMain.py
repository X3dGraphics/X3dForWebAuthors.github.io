...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='VisibilitySensorKelpForestMain.x3d',name='title'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/VisibilitySensorKelpForestMain.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    VisibilitySensor(DEF='SeeMe',center=(0,-3.5,-2),size=(20,11,11)),
...
print('Self-test diagnostics for VisibilitySensorKelpForestMain.py:')
...
print("python VisibilitySensorKelpForestMain.py load and self-test diagnostics complete.")
