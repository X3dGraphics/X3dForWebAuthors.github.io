...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/LoadSensor.x3d',name='identifier'),
    ...
    Transform(DEF='PivotTextSigns',translation=(0,3,0),
      ...
      Shape(
        geometry=Text(length=[0],string=["LoadSensor waiting for HelloWorld scene..."],
          fontStyle=FontStyle(justify=["MIDDLE","MIDDLE"],size=0.7,style='ITALIC')),
...
print ("python x3d.py load successful for LoadSensor.py")
