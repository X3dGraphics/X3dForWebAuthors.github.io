...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/ProximitySensorSingle.x3d',name='identifier'),
...
print('Self-test diagnostics for ProximitySensorSingle.py:')
...
print("python ProximitySensorSingle.py load and self-test diagnostics complete.")
