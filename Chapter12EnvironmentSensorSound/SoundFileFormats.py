...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/SoundFileFormats.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(DEF='WavPlay',scale=(0.4,0.4,0.4),translation=(-4,0.5,0),
      ...
      Sound(maxBack=100,maxFront=100,minBack=20,minFront=20,
        ...
        source=AudioClip(DEF='Testing123stereoWavAudioClip',description='Playing Testing123stereo.wav',url=["audio/Testing123stereo.wav","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.wav"])),
    ...
    Transform(DEF='WavLaunch',scale=(0.4,0.4,0.4),translation=(-4,-0.1,0),
      children=[
      Anchor(description='Launch audio file in Web browser: Testing123stereo.wav',parameter=["target=_blank"],url=["audio/Testing123stereo.wav","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.wav"],
        children=[
        Shape(
    ...
    Transform(DEF='Mp3Play',scale=(0.4,0.4,0.4),translation=(0,0.5,0),
      ...
      Sound(maxBack=100,maxFront=100,minBack=20,minFront=20,
        source=AudioClip(DEF='Testing123stereoMp3AudioClip',description='Play file via Sound/AudioClip: Testing123stereo.mp3',url=["audio/Testing123stereo.mp3","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.mp3"])),
    ...
    Transform(DEF='Mp3Launch',scale=(0.4,0.4,0.4),translation=(0,-0.1,0),
      children=[
      Anchor(description='Launch audio file in Web browser: Testing123stereo.mp3',parameter=["target=_blank"],url=["audio/Testing123stereo.mp3","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.mp3"],
        children=[
        Shape(
          geometry=Text(string=["(launch)"],
            fontStyle=FontStyle(USE='MessageFont')),
    ...
    Transform(DEF='MidiPlay',scale=(0.4,0.4,0.4),translation=(0,-2,0),
      ...
      Sound(maxBack=100,maxFront=100,minBack=20,minFront=20,
        source=AudioClip(DEF='Testing123stereoMidiAudioClip',description='Play file via Sound/AudioClip: Reunion_Example.mid',url=["audio/Reunion_Example.mid","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Reunion_Example.mid"])),
    ...
    Transform(DEF='MidiLaunch',scale=(0.4,0.4,0.4),translation=(0,-2.6,0),
      children=[
      Anchor(description='Launch audio file in Web browser: Reunion_Example.mid',parameter=["target=_blank"],url=["audio/Reunion_Example.mid","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Reunion_Example.mid"],
        children=[
        Shape(
          geometry=Text(string=["(launch)"],
            fontStyle=FontStyle(USE='MessageFont')),
    ...
    Transform(DEF='AiffPlay',scale=(0.4,0.4,0.4),translation=(4,0.5,0),
      ...
      Sound(maxBack=100,maxFront=100,minBack=20,minFront=20,
        source=AudioClip(DEF='Testing123stereoAiffAudioClip',description='Play file via Sound/AudioClip: Testing123stereo.aiff',url=["audio/Testing123stereo.aiff","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.aiff"])),
    ...
    Transform(DEF='AiffLaunch',scale=(0.4,0.4,0.4),translation=(4,-0.1,0),
      children=[
      Anchor(description='Launch audio file in Web browser: Testing123stereo.aiff',parameter=["target=_blank"],url=["audio/Testing123stereo.aiff","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/audio/Testing123stereo.aiff"],
        children=[
        Shape(
          geometry=Text(string=["(launch)"],
            fontStyle=FontStyle(USE='MessageFont')),
...
print('Self-test diagnostics for SoundFileFormats.py:')
...
print("python SoundFileFormats.py load and self-test diagnostics complete.")
