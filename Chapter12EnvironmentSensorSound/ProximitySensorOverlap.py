...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/ProximitySensorOverlap.x3d',name='identifier'),
...
print('Self-test diagnostics for ProximitySensorOverlap.py:')
...
print("python ProximitySensorOverlap.py load and self-test diagnostics complete.")
