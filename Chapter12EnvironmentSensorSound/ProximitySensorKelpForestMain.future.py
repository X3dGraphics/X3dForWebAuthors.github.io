...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("ProximitySensorKelpForestMain.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("This example uses a ProximitySensor node to position a heads-up display (HUD) in the Kelp Forest world.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound/ProximitySensorKelpForestMain.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
# display-related fields 
    ...
    .addChild(Group() \
     ...
     .addChild(Inline() \
      .setUrl(["IntroductionMessage.x3d","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/IntroductionMessage.x3d","../KelpForestExhibit/IntroductionMessage.wrl","http://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/IntroductionMessage.wrl"]) \
     ) \
     .addChild(Collision() \
      .setEnabled(False) \
      .setProxy(Transform() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter12EnvironmentSensorSound//ProximitySensorKelpForestMain_RoundTrip.x3d")
