...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Instantiate the standard Garibaldi fish prototype.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/Garibaldi.x3d',name='identifier'),
...
print('Self-test diagnostics for Garibaldi.py:')
...
print("python Garibaldi.py load and self-test diagnostics complete.")
