...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureBW.x3d',name='identifier'),
...
print('Self-test diagnostics for PixelTextureBW.py:')
...
print("python PixelTextureBW.py load and self-test diagnostics complete.")
