...
print('Self-test diagnostics for GeometryPrimitiveNodesImageTexture.py:')
...
print("python GeometryPrimitiveNodesImageTexture.py load and self-test diagnostics complete.")
