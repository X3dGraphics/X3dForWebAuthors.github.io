...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='TextureRemoteGaribaldi.x3d',name='title'),
    meta(content='Instantiate the Garibaldi fish prototype without a skin texture.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/TextureRemoteGaribaldi.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TextureRemoteGaribaldi.x3d'),
...
print('Self-test diagnostics for TextureRemoteGaribaldi.py:')
...
print("python TextureRemoteGaribaldi.py load and self-test diagnostics complete.")
