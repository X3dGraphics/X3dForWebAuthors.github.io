...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='GaribaldiLocalTexture.x3d',name='title'),
    meta(content='Instantiate the Garibaldi fish prototype using a local skin texture file.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/GaribaldiLocalTexture.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='GaribaldiLocalTexture.x3d'),
...
print('Self-test diagnostics for GaribaldiLocalTexture.py:')
...
print("python GaribaldiLocalTexture.py load and self-test diagnostics complete.")
