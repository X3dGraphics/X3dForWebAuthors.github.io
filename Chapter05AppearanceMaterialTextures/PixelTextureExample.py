...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureExample.x3d',name='identifier'),
...
print('Self-test diagnostics for PixelTextureExample.py:')
...
print("python PixelTextureExample.py load and self-test diagnostics complete.")
