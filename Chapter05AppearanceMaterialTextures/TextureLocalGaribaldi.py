...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/TextureLocalGaribaldi.x3d',name='identifier'),
...
print('Self-test diagnostics for TextureLocalGaribaldi.py:')
...
print("python TextureLocalGaribaldi.py load and self-test diagnostics complete.")
