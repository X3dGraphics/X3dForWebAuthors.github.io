...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/FillProperties.x3d',name='identifier'),
        ...
        Transform(translation=(-9,0,0),
          ...
          Shape(
            geometry=Text(string=["1"],
              fontStyle=FontStyle(DEF='Middle',justify=["MIDDLE","MIDDLE"],size=2,style='BOLD')),
...
print ("python x3d.py load successful for FillProperties.py")
