...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/frosty2.mid',name='Sound'),
    meta(content='http://www.the-north-pole.com/carols/frosty.html',name='reference'),
    meta(content='https://X3dGraphics.com',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/X3dResources.html',name='reference'),
    meta(content='X3D book, X3D graphics, X3D-Edit, http://www.x3dGraphics.com',name='subject'),
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureSnowman.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Sound(location=(0,1.6,0),maxBack=50,maxFront=50,minBack=5,minFront=5,priority=1,
      source=AudioClip(description='Frosty the Snowman',loop=True,url=["frosty2.mid","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/frosty2.mid"])),
...
print('Self-test diagnostics for PixelTextureSnowman.py:')
...
print("python PixelTextureSnowman.py load and self-test diagnostics complete.")
