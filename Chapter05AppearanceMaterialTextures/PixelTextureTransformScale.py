...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/PixelTextureTransformScale.x3d',name='identifier'),
...
print('Self-test diagnostics for PixelTextureTransformScale.py:')
...
print("python PixelTextureTransformScale.py load and self-test diagnostics complete.")
