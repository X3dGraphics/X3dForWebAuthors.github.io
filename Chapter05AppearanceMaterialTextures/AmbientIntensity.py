...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/AmbientIntensity.x3d',name='identifier'),
...
print('Self-test diagnostics for AmbientIntensity.py:')
...
print("python AmbientIntensity.py load and self-test diagnostics complete.")
