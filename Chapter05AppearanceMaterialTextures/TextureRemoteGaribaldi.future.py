...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("TextureRemoteGaribaldi.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Instantiate the Garibaldi fish prototype without a skin texture.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures/TextureRemoteGaribaldi.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter05AppearanceMaterialTextures//TextureRemoteGaribaldi_RoundTrip.x3d")
