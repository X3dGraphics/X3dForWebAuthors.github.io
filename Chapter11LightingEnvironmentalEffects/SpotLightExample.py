...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='Example SpotLight node showing effects of beamWidth and cutOffAngle',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/SpotLightExample.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='Book Viewpoint',position=(0,0,30)),
