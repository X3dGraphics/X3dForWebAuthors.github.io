...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    children=[
    meta(content='SpotLightColor.x3d',name='title'),
    meta(content='Example of SpotLight showing effect of varying light colors on appearance',name='description'),
...
print('Self-test diagnostics for SpotLightColor.py:')
...
print("python SpotLightColor.py load and self-test diagnostics complete.")
