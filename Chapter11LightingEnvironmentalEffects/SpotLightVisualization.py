...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/SpotLightVisualization.x3d',name='identifier'),
...
print('Self-test diagnostics for SpotLightVisualization.py:')
...
print("python SpotLightVisualization.py load and self-test diagnostics complete.")
