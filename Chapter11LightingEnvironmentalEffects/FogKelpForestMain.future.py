...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("FogKelpForestMain.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Added fog to the KelpForest world to simulate the typical weather pattern in June in Monterey, CA.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/FogKelpForestMain.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects//FogKelpForestMain_RoundTrip.x3d")
