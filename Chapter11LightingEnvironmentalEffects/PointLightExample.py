...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='Two examples of scoped PointLight nodes showing the effects of distance on lit geometry. Faceted IndexedFaceSet is on the left, simple Box on the right.',name='description'),
    meta(content='Leonard Daly and Don Brutzman',name='creator'),
    meta(content='24 April 2006',name='created'),
    meta(content='14 June 2020',name='modified'),
    meta(content='PointLightVisualization.png',name='Image'),
    meta(content='https://X3dGraphics.com',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/X3dResources.html',name='reference'),
    meta(content='Copyright 2006, Daly Realism and Don Brutzman',name='rights'),
    meta(content='X3D book, X3D graphics, X3D-Edit, http://www.x3dGraphics.com',name='subject'),
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/PointLight.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='Common viewpoint',position=(0,0,40)),
    Transform(translation=(-15,0,0),
      children=[
      Viewpoint(description='Faceted box, smooth shading',position=(0,0,25)),
      PointLight(DEF='Lamp1',color=(1,1,0),location=(0,0,6),radius=15),
      Transform(DEF='FacetedBox',
        children=[
        Shape(
          appearance=Appearance(
            material=Material(DEF='OffWhite',diffuseColor=(.95,.95,.95))),
    ...
    Transform(translation=(15,0,0),
      children=[
      Viewpoint(description='Simple box, constant shading',position=(0,0,25)),
      PointLight(DEF='Lamp2',color=(1,1,0),location=(0,0,6),radius=15),
      Transform(DEF='SimpleBox',
        children=[
        Shape(
          appearance=Appearance(
