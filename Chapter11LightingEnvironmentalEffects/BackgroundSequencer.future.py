...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("BackgroundSequencer.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Cycle through four Background nodes to show a time-of-day effect.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/BackgroundSequencer.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    .addChild(Transform() \
     ...
     .addChild(Shape() \
      .setGeometry(Text() \
       .setString(["Background Sequencer"]) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects//BackgroundSequencer_RoundTrip.x3d")
