...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/BackgroundKelpForestMain.x3d',name='identifier'),
...
print('Self-test diagnostics for BackgroundKelpForestMain.py:')
...
print("python BackgroundKelpForestMain.py load and self-test diagnostics complete.")
