...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter11LightingEnvironmentalEffects/FogKelpForestMain.x3d',name='identifier'),
...
print('Self-test diagnostics for FogKelpForestMain.py:')
...
print("python FogKelpForestMain.py load and self-test diagnostics complete.")
