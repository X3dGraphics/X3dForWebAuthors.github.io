...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Circle2D.x3d',name='title'),
    meta(content='Example of Circle2D node showing a simple circular circumference.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/Circle2D.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Circle2D.x3d'),
    Viewpoint(description='Circle2D example'),
...
print ("python x3d.py load successful for Circle2D.py")
