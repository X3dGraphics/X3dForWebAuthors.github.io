...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/Disk2dExample.x3d',name='identifier'),
...
print('Self-test diagnostics for Disk2dExample.py:')
...
print("python Disk2dExample.py load and self-test diagnostics complete.")
