...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/Rectangle2D.x3d',name='identifier'),
...
print('Self-test diagnostics for Rectangle2dExample.py:')
...
print("python Rectangle2dExample.py load and self-test diagnostics complete.")
