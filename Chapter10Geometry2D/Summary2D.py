...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/Summary2D.x3d',name='identifier'),
...
print('Self-test diagnostics for Summary2D.py:')
...
print("python Summary2D.py load and self-test diagnostics complete.")
