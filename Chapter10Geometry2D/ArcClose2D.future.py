...
X3D0 = X3D() \
   ...
   .setHead(head() \
    ...
    .addMeta(meta() \
     .setContent("ArcClose2D.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Example of ArcClose2D showing PIE or CHORD subsections of circular geometry.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/ArcClose2D.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDescription("ArcClose2D example") \
    ) \
    .addChild(Transform() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter10Geometry2D//ArcClose2D_RoundTrip.x3d")
