...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Arc2dExample.x3d',name='title'),
    meta(content='Example of Arc2D node showing semicircular arcs',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/Arc2dExample.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Arc2D.x3d'),
    Background(skyColor=[(1,1,1)]),
    Viewpoint(description='Arc2D example'),
...
print('Self-test diagnostics for Arc2dExample.py:')
...
print("python Arc2dExample.py load and self-test diagnostics complete.")
