...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='ArcClose2D.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter10Geometry2D/ArcClose2D.x3d',name='identifier'),
...
print ("python x3d.py load successful for ArcClose2D.py")
