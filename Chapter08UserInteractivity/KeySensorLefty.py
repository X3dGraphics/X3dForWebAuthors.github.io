...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/KeySensorLefty.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='KeyHandler',url=["KeySensorLeftyScript.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/KeySensorLeftyScript.js"],
      field=[
...
print('Self-test diagnostics for KeySensorLefty.py:')
...
print("python KeySensorLefty.py load and self-test diagnostics complete.")
