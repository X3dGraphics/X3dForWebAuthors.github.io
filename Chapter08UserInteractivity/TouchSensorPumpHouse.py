...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/TouchSensorPumpHouse.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='TouchSensorPumpHouse.x3d'),
    ...
    Group(
      ...
      Transform(scale=(0.91,0.6,0.3),translation=(0.8,-0.65,0.5),
        ...
        Shape(
          ...
          geometry=Cylinder(bottom=False,solid=False,top=False))]),
      Group(
        children=[
        TouchSensor(DEF='PumpTouched',description='touch housing to activate pump'),
        Shape(
...
print('Self-test diagnostics for TouchSensorPumpHouse.py:')
...
print("python TouchSensorPumpHouse.py load and self-test diagnostics complete.")
