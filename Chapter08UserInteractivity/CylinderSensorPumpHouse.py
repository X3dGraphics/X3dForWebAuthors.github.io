...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/CylinderSensorPumpHouse.x3d',name='identifier'),
...
print('Self-test diagnostics for CylinderSensorPumpHouse.py:')
...
print("python CylinderSensorPumpHouse.py load and self-test diagnostics complete.")
