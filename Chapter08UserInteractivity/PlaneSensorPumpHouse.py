...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='PlaneSensor on the red handle controls the overall movement of a positive-displacement cylinder pump.',name='description'),
    ...
    meta(content='StringSensorScriptConverter.js',name='reference'),
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/PumpHouse.x3d',name='reference'),
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/PlaneSensorPumpHouse.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='PlaneSensorPumpHouse.x3d'),
...
"""),
        ROUTE(fromField='translation_changed',fromNode='PumpAmplitude',toField='SFVec3fY_SFFloat',toNode='Converter'),
        ROUTE(fromField='translation_changed',fromNode='PumpAmplitude',toField='translation',toNode='AmplitudeMarker'),
        ROUTE(fromField='SFFloat_Yout',fromNode='Converter',toField='set_fraction',toNode='PistonLimits')])]),
    Group(
      children=[
    ...
    ROUTE(fromField='isActive',fromNode='PumpTouchedOption',toField='enabled',toNode='PistonClock'),
    ROUTE(fromField='value_changed',fromNode='PistonLimits',toField='keyValue',toNode='PistonPath'),
...
print('Self-test diagnostics for PlaneSensorPumpHouse.py:')
...
print("python PlaneSensorPumpHouse.py load and self-test diagnostics complete.")
