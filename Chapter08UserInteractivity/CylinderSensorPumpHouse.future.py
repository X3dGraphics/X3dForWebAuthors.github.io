...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("CylinderSensorPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("A CylinderSensor changes the viewing position of a positive-displacement cylinder pump house.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/CylinderSensorPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDEF("AdjustableView") \
     .setDescription("Adjustible Viewpoint") \
     .setPosition([0.02,0.45,5]) \
    ) \
    .addChild(Transform() \
     .setTranslation([1.75,1,0]) \
     .addChild(CylinderSensor() \
      .setDEF("Mover") \
      .setDescription("click and drag to rotate") \
      .setDiskAngle(1.56) \
      .setMaxAngle(0.3) \
      .setMinAngle(-0.3) \
     ) \
     .addChild(Shape() \
      .setAppearance(Appearance() \
       .setMaterial(Material() \
        .setDiffuseColor([.9,.9,.9]) \
       ) \
      ) \
      .setGeometry(Box(size = [1,1.25,.02]) \
      ) \
     ) \
     .addChild(Transform() \
      .addChild(Transform() \
       .addChild(Transform() \
        ...
        .addChild(Shape() \
         ...
         .setGeometry(Cylinder(height = .3, radius = .3) \
         ) \
        ) \
       ) \
      ) \
       ...
       .addChild(Transform() \
        ...
        .addChild(Transform() \
         ...
         .addChild(Shape() \
          ...
          .setGeometry(Cone(bottomRadius = .1, height = .6) \
          ) \
         ) \
        ) \
       ) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter08UserInteractivity//CylinderSensorPumpHouse_RoundTrip.x3d")
