...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("TouchSensorPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("TouchSensor activated positive-displacement cylinder pump house.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter08UserInteractivity/TouchSensorPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
    ...
    .addChild(Group() \
     .addChild(Transform() \
      ...
      .addChild(Shape() \
       ...
       .setGeometry(Cylinder(bottom = False, solid = False) \
        .setTop(False) \
       ) \
      ) \
     ) \
     .addChild(Group() \
      .addChild(TouchSensor() \
       .setDEF("PumpTouched") \
       .setDescription("touch housing to activate pump") \
      ) \
      .addChild(Shape() \
       .setAppearance(Appearance() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter08UserInteractivity//TouchSensorPumpHouse_RoundTrip.x3d")
