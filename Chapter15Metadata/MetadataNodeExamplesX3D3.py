...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='MetadataNodeExamplesX3D3.x3d',name='title'),
    ...
    meta(content='18 January 2022',name='modified'),
    ...
    meta(content='MetadataNodeExamplesX3D4.x3d',name='reference'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter15Metadata/MetadataNodeExamplesX3D3.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    WorldInfo(DEF='MyWorldInfo',info=["Metadata strings","can go here","as string array values"],title='MetadataNodeExamplesX3D3.x3d Example Scene',
...
print('Self-test diagnostics for MetadataNodeExamplesX3D3.py:')
...
print("python MetadataNodeExamplesX3D3.py load and self-test diagnostics complete.")
