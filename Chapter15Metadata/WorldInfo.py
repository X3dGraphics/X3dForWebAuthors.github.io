...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='WorldInfo.x3d',name='title'),
    meta(content='Simple examples of meta statements, comments, WorldInfo node and a MetadataString node.',name='description'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter15Metadata/WorldInfo.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Anchor(description='Load scene index page',parameter=["target=_blank"],url=["WorldInfoIndex.html","http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter15Metadata/WorldInfoIndex.html"],
      children=[
      Shape(
        geometry=Text(string=["View scene source","to see","WorldInfo example"],
...
print ("python x3d.py load successful for WorldInfo.py")
