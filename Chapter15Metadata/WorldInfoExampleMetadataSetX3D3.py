...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter15Metadata/WorldInfoExampleMetadataSetX3D3.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Anchor(description='Load scene index page',parameter=["target=_blank"],url=["WorldInfoExampleMetadataSetX3D3.html","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter15Metadata/WorldInfoExampleMetadataSetX3D3.html"],
      children=[
      Shape(
        geometry=Text(string=["View scene source","to see","WorldInfoExampleMetadataSetX3D3"],
...
print('Self-test diagnostics for WorldInfoExampleMetadataSetX3D3.py:')
...
print("python WorldInfoExampleMetadataSetX3D3.py load and self-test diagnostics complete.")
