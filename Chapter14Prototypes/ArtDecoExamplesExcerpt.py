...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoExamplesExcerpt.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ExternProtoDeclare(appinfo='UniversalMediaMaterials prototype',documentation='https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials',name='ArtDeco00',url=["ArtDecoPrototypesExcerpt.x3d#ArtDeco00","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco00","ArtDecoPrototypesExcerpt.wrl#ArtDeco00","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.wrl#ArtDeco00"]),
    ExternProtoDeclare(appinfo='UniversalMediaMaterials prototype',documentation='https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials',name='ArtDeco01',url=["ArtDecoPrototypesExcerpt.x3d#ArtDeco01","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco01","ArtDecoPrototypesExcerpt.wrl#ArtDeco01","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.wrl#ArtDeco01"]),
    ExternProtoDeclare(appinfo='UniversalMediaMaterials prototype',documentation='https://www.web3d.org/x3d/content/examples/Basic/UniversalMediaMaterials',name='ArtDeco02',url=["ArtDecoPrototypesExcerpt.x3d#ArtDeco02","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.x3d#ArtDeco02","ArtDecoPrototypesExcerpt.wrl#ArtDeco02","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.wrl#ArtDeco02"]),
    Group(
      children=[
      ...
      Transform(translation=(-2.25,3.75,0.0),
        ...
        Transform(translation=(0.0,0.3,0.5),
          children=[
          Anchor(description='ArtDeco01',parameter=["target=_source"],url=["ArtDecoPrototypesExcerpt.html#ProtoDeclare_ArtDeco01","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.html#ProtoDeclare_ArtDeco01"],
            children=[
            Shape(
              appearance=Appearance(
      ...
      Transform(translation=(-0.75,3.75,0.0),
        ...
        Transform(translation=(0.0,0.3,0.5),
          children=[
          Anchor(description='ArtDeco02',parameter=["target=_source"],url=["ArtDecoPrototypesExcerpt.html#ProtoDeclare_ArtDeco02","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ArtDecoPrototypesExcerpt.html#ProtoDeclare_ArtDeco02"],
            children=[
            Shape(
              appearance=Appearance(
                material=Material(USE='TextMat')),
...
print('Self-test diagnostics for ArtDecoExamplesExcerpt.py:')
...
print("python ArtDecoExamplesExcerpt.py load and self-test diagnostics complete.")
