...
print('Self-test diagnostics for MaterialModulatorExamples.py:')
...
print("python MaterialModulatorExamples.py load and self-test diagnostics complete.")
