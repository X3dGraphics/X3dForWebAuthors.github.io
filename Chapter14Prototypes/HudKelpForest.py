...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HudKelpForest.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ConvertValueScript',url=["HudKelpForestScriptConvert.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HudKelpForestScriptConvert.js"],
      field=[
...
print('Self-test diagnostics for HudKelpForest.py:')
...
print("python HudKelpForest.py load and self-test diagnostics complete.")
