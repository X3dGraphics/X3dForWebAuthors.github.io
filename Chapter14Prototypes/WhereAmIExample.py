...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/WhereAmIExample.x3d',name='identifier'),
...
print('Self-test diagnostics for WhereAmIExample.py:')
...
print("python WhereAmIExample.py load and self-test diagnostics complete.")
