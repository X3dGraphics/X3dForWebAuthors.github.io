...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototype.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    ProtoDeclare(appinfo='Display view frustum associated with a given pair of Viewpoint NavigationInfo nodes',name='ViewFrustum',
      ...
      ProtoBody=ProtoBody(
        ...
        Script(DEF='GeometryComputationScript',directOutput=True,url=["ViewFrustumPrototypeScript.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumPrototypeScript.js"],
          field=[
...
"""),
    ...
    Anchor(description='ViewFrustum Example',url=["ViewFrustumExample.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.x3d","ViewFrustumExample.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/ViewFrustumExample.wrl"],
      children=[
      Shape(
        appearance=Appearance(
