...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter14Prototypes/HeadsUpDisplayExample.x3d',name='identifier'),
...
print('Self-test diagnostics for HeadsUpDisplayExample.py:')
...
print("python HeadsUpDisplayExample.py load and self-test diagnostics complete.")
