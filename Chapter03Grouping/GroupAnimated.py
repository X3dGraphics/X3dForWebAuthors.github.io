...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/GroupAnimated.x3d',name='identifier'),
...
print('Self-test diagnostics for GroupAnimated.py:')
...
print("python GroupAnimated.py load and self-test diagnostics complete.")
