...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/Transform.x3d',name='identifier'),
...
print('Self-test diagnostics for Transform.py:')
...
print("python Transform.py load and self-test diagnostics complete.")
