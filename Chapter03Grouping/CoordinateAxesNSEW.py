...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxesNSEW.x3d',name='identifier'),
    ...
    Collision(DEF='DoNotCollideWithVisualizationWidget',enabled=False,
      ...
      Group(
        ...
        Group(DEF='ArrowGreen',
          children=[
          Shape(
            geometry=Cylinder(DEF='ArrowCylinder',bottom=False,radius=.025,top=False),
        ...
        Transform(translation=(0,1.08,0),
          ...
          Billboard(
            ...
            Shape(
              ...
              geometry=Text(string=["+Y","Up"],
                fontStyle=FontStyle(DEF='LABEL_FONT_TOP',family=["SANS"],justify=["MIDDLE","END"],size=.2)))])]),
        Transform(translation=(0,-1.08,0),
          children=[
          Billboard(
            children=[
            Shape(
              ...
              geometry=Text(string=["-Y","Down"],
                fontStyle=FontStyle(USE='LABEL_FONT_TOP')))])])]),
...
print('Self-test diagnostics for CoordinateAxesNSEW.py:')
...
print("python CoordinateAxesNSEW.py load and self-test diagnostics complete.")
