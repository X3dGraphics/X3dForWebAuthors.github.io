...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/OrderOfOperations1.x3d',name='identifier'),
...
print('Self-test diagnostics for OrderOfOperations1.py:')
...
print("python OrderOfOperations1.py load and self-test diagnostics complete.")
