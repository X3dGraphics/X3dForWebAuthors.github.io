...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/BoundingBoxIllustration.x3d',name='identifier'),
...
print('Self-test diagnostics for BoundingBoxIllustration.py:')
...
print("python BoundingBoxIllustration.py load and self-test diagnostics complete.")
