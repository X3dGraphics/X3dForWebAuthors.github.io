...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='StaticGroupExample.x3d',name='title'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/StaticGroupExample.x3d',name='identifier'),
...
print('Self-test diagnostics for StaticGroupExample.py:')
...
print("python StaticGroupExample.py load and self-test diagnostics complete.")
