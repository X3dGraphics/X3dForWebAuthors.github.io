...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/Switch.x3d',name='identifier'),
...
print('Self-test diagnostics for Switch.py:')
...
print("python Switch.py load and self-test diagnostics complete.")
