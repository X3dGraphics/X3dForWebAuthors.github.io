...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxesLines.x3d',name='identifier'),
...
print('Self-test diagnostics for CoordinateAxesLines.py:')
...
print("python CoordinateAxesLines.py load and self-test diagnostics complete.")
