...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='Group.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/Group.x3d',name='identifier'),
...
print ("python x3d.py load successful for Group.py")
