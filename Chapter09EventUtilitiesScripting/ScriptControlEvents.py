...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptControlEvents.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ControlScript',url=["ScriptControlEvents.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptControlEvents.js"],
      field=[
...
print('Self-test diagnostics for ScriptControlEvents.py:')
...
print("python ScriptControlEvents.py load and self-test diagnostics complete.")
