...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='IntegerSequencerPumpHouse.x3d'),
    ...
    Transform(translation=(3,2,0.5),
      ...
      Transform(DEF='ConeRotationTransform',
        ...
        ROUTE(fromField='value_changed',fromNode='Rotator',toField='set_rotation',toNode='ConeRotationTransform'),
        ...
        Switch(DEF='Switcher',whichChoice=0,
          children=[
          Transform(rotation=(0,0,1,-1.05),translation=(0,-1.5,.5),
            children=[
            Shape(
              appearance=Appearance(
        ...
        ROUTE(fromField='isActive',fromNode='PumpTouched',toField='next',toNode='Sequencer')])]),
    Group(
      children=[
...
print('Self-test diagnostics for IntegerSequencerPumpHouse.py:')
...
print("python IntegerSequencerPumpHouse.py load and self-test diagnostics complete.")
