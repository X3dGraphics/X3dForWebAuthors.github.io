...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptComplexStateEvents.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ControlScript',url=["ScriptComplexStateEvents.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptComplexStateEvents.js"],
      field=[
...
print('Self-test diagnostics for ScriptComplexStateEvents.py:')
...
print("python ScriptComplexStateEvents.py load and self-test diagnostics complete.")
