...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/MoodSelector.x3d',name='identifier'),
      ...
      Transform(translation=(-5,-3,0),
        ...
        Shape(DEF='happyimg',
          ...
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["images/nicubunu_Emoticons_Laughing_face.png","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/images/nicubunu_Emoticons_Laughing_face.png"])))]),
      Transform(translation=(-1.3,-3,0),
        ...
        Shape(DEF='nbimg',
          ...
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["images/nicubunu_Emoticons_Worried_face.png","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/images/nicubunu_Emoticons_Worried_face.png"])))]),
      Transform(translation=(2.2,-3,0),
        ...
        Shape(DEF='sadimg',
          ...
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["images/nicubunu_Emoticons_Crying_face.png","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/images/nicubunu_Emoticons_Crying_face.png"])))]),
      Transform(translation=(4.7,-3,0),
        ...
        Shape(DEF='bullimg',
          ...
          appearance=Appearance(
            ...
            texture=ImageTexture(url=["images/nicubunu_Emoticons_Devil_face.png","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/images/nicubunu_Emoticons_Devil_face.png"])))])]),
...
print('Self-test diagnostics for MoodSelector.py:')
...
print("python MoodSelector.py load and self-test diagnostics complete.")
