...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("BooleanFilterPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("A BooleanFilter node starts the animation of cones orbiting near the pump house, instead of an unfiltered TouchSensor toggling the animation on/off during selection/deselection.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanFilterPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDescription("Click pump house to activate") \
     .setPosition([2,1,9]) \
    ) \
    .addChild(TimeSensor() \
     .setDEF("Timer") \
    ...
    .addChild(Transform() \
     .setDEF("SpinningColoredCones") \
     .setTranslation([3,2,1]) \
     .addChild(Transform() \
    ...
    .addChild(ROUTE() \
     ...
     .setFromNode("Rotator") \
     .setToField("rotation") \
     .setToNode("SpinningColoredCones") \
    ) \
    .addChild(Group() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting//BooleanFilterPumpHouse_RoundTrip.x3d")
