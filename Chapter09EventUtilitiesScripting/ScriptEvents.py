...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptEvents.x3d',name='identifier'),
...
print('Self-test diagnostics for ScriptEvents.py:')
...
print("python ScriptEvents.py load and self-test diagnostics complete.")
