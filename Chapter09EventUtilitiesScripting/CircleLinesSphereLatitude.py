...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/CircleLinesSphereLatitude.x3d',name='identifier'),
...
print('Self-test diagnostics for CircleLinesSphereLatitude.py:')
...
print("python CircleLinesSphereLatitude.py load and self-test diagnostics complete.")
