...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("BooleanTriggerPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("A BooleanTrigger node initiates the pump house animation: select to start. This model shows a positive-displacement cylinder pump to emulate breakers surge, designed and built by David Packard.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTriggerPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDescription("select pump house to activate") \
     ...
     .addChild(Transform() \
      ...
      .addChild(Transform() \
       ...
       .addChild(ROUTE() \
        ...
        .setToNode("TriggerStart") \
       ) \
       .addChild(ROUTE() \
        .setFromField("triggerTrue") \
        .setFromNode("TriggerStart") \
        .setToField("enabled") \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting//BooleanTriggerPumpHouse_RoundTrip.x3d")
