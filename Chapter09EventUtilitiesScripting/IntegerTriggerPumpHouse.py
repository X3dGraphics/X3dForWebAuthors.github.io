...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerTriggerPumpHouse.x3d',name='identifier'),
...
print('Self-test diagnostics for IntegerTriggerPumpHouse.py:')
...
print("python IntegerTriggerPumpHouse.py load and self-test diagnostics complete.")
