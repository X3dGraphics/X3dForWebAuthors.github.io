...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    children=[
    meta(content='BooleanToggle.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanToggle.x3d',name='identifier'),
...
print ("python x3d.py load successful for BooleanToggle.py")
