...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/TestScriptInitialization.x3d',name='identifier'),
...
print('Self-test diagnostics for TestScriptInitialization.py:')
...
print("python TestScriptInitialization.py load and self-test diagnostics complete.")
