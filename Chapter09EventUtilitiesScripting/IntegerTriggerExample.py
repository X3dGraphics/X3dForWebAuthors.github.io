...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerTriggerExample.x3d',name='identifier'),
...
print('Self-test diagnostics for IntegerTriggerExample.py:')
...
print("python IntegerTriggerExample.py load and self-test diagnostics complete.")
