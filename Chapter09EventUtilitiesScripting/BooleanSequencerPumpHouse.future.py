...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("BooleanSequencerPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("A BooleanSequencer node intermittently interrupts animation of the pump house.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
     .setContent("Leonard Daly, Don Brutzman, Todd Gagnon and Mark A. Boyd") \
     .setName("creator") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanSequencerPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDescription("touch and hold to interrupt pump operation") \
     .setOrientation([-0.969,0.239,0.056,0.13]) \
     .setPosition([1.66,1.34,5.95]) \
    ) \
    .addChild(Group() \
     .setDEF("PumpHouseGroup") \
     .addChild(Transform() \
     ...
     .addChild(Transform() \
      ...
      .addChild(Transform() \
       ...
       .addChild(BooleanSequencer() \
        ...
        .setKey([0,0.25,0.33,0.5,0.625,0.67,0.75,0.9,1]) \
        .setKeyValue([true,false,true,false,true,false,true,false,true]) \
       ) \
       .addChild(TimeSensor() \
        .setDEF("InterruptTimer") \
        .setCycleInterval(6) \
        .setStartTime(1) \
       ) \
       .addChild(ROUTE() \
       ...
       .addChild(ROUTE() \
        .setFromField("fraction_changed") \
        .setFromNode("InterruptTimer") \
        .setToField("set_fraction") \
        .setToNode("OnOffSequencer") \
       ) \
       .addChild(ROUTE() \
        .setFromField("isActive") \
        .setFromNode("InterruptPump") \
        .setToField("enabled") \
        .setToNode("InterruptTimer") \
       ) \
       .addChild(Transform() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting//BooleanSequencerPumpHouse_RoundTrip.x3d")
