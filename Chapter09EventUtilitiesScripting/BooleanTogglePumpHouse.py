...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='BooleanTogglePumpHouse.x3d',name='title'),
    meta(content='A BooleanToggle node controls pump house animation: select to stop, then select again to restart.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTogglePumpHouse.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Viewpoint(description='Click pump house to toggle operation',orientation=(-0.969,0.239,0.056,0.13),position=(1.66,1.34,5.95)),
    Group(
      children=[
    ...
    Group(
      ...
      Transform(scale=(0.5,0.5,0.5),translation=(1.0,1.1,-1.5),
        ...
        TimeSensor(DEF='PistonClock',cycleInterval=5.5,loop=True,startTime=1),
    ...
    Script(DEF='Dump',url=["BooleanTogglePumpHouseScript.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTogglePumpHouseScript.js"],
      field=[
      field(accessType='inputOnly',name='dumpSFBool',type='SFBool'),
      field(accessType='inputOnly',name='dumpSFTime',type='SFTime')],

    sourceCode="""
ecmascript:

"""),
    ROUTE(fromField='isActive',fromNode='PumpTouched',toField='set_boolean',toNode='Toggler'),
    ROUTE(fromField='inputTrue',fromNode='Tee',toField='dumpSFBool',toNode='Dump'),
    ROUTE(fromField='triggerTime',fromNode='PauseOn',toField='dumpSFTime',toNode='Dump'),
    ...
    ROUTE(fromField='triggerTime',fromNode='PauseOn',toField='pauseTime',toNode='PistonClock'),
    ROUTE(fromField='triggerTime',fromNode='PauseOff',toField='resumeTime',toNode='PistonClock'),
...
print('Self-test diagnostics for BooleanTogglePumpHouse.py:')
...
print("python BooleanTogglePumpHouse.py load and self-test diagnostics complete.")
