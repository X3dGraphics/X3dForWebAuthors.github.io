...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanTriggerPumpHouse.x3d',name='identifier'),
...
print('Self-test diagnostics for BooleanTriggerPumpHouse.py:')
...
print("python BooleanTriggerPumpHouse.py load and self-test diagnostics complete.")
