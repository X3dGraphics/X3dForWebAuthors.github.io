...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptSimpleStateEvents.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Script(DEF='ControlScript',url=["ScriptSimpleStateEvents.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptSimpleStateEvents.js"],
      field=[
...
print('Self-test diagnostics for ScriptSimpleStateEvents.py:')
...
print("python ScriptSimpleStateEvents.py load and self-test diagnostics complete.")
