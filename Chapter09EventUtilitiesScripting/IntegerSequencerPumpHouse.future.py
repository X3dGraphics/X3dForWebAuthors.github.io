...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("IntegerSequencerPumpHouse.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("An IntegerSequencer node switches the display of colored cones near the pump house.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/IntegerSequencerPumpHouse.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    ...
    .addChild(Viewpoint() \
     .setDescription("Click pump house for next cone") \
    ...
    .addChild(Transform() \
     .setTranslation([3,2,0.5]) \
     .addChild(Transform() \
      .setDEF("ConeRotationTransform") \
      ...
      .addChild(ROUTE() \
       ...
       .setToNode("ConeRotationTransform") \
      ) \
      .addChild(TimeSensor() \
       .setDEF("Timer") \
       .setCycleInterval(2) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting//IntegerSequencerPumpHouse_RoundTrip.x3d")
