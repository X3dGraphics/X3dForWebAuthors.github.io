...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptEventsPumpHouse.x3d',name='identifier'),
          ...
          Transform(DEF='EyeCandy',
            ...
            Transform(DEF='CandyTurquoise',rotation=(0,0,1,1.05),translation=(-1.3,.75,-.5),
              ...
              Shape(
                ...
                geometry=Cone(USE='b1'))])])]),
        Script(DEF='Control',url=["ScriptEventsPumpHouse.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/ScriptEventsPumpHouse.js"],
          field=[
...
print('Self-test diagnostics for ScriptEventsPumpHouse.py:')
...
print("python ScriptEventsPumpHouse.py load and self-test diagnostics complete.")
