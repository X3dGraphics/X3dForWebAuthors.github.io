...
newModel=X3D(profile='Interactive',version='3.3',
  head=head(
    children=[
    meta(content='BooleanFilterPumpHouse.x3d',name='title'),
    meta(content='A BooleanFilter node starts the animation of cones orbiting near the pump house, instead of an unfiltered TouchSensor toggling the animation on/off during selection/deselection.',name='description'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter09EventUtilitiesScripting/BooleanFilterPumpHouse.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='BooleanFilterPumpHouse.x3d'),
    Background(skyColor=[(1,1,1)]),
    NavigationInfo(type='"FLY" "ANY"'),
    Viewpoint(description='Click pump house to activate',position=(2,1,9)),
    ...
    Transform(DEF='SpinningColoredCones',translation=(3,2,1),
      children=[
    ...
    ROUTE(fromField='value_changed',fromNode='Rotator',toField='rotation',toNode='SpinningColoredCones'),
    Group(
      children=[
...
print('Self-test diagnostics for BooleanFilterPumpHouse.py:')
...
print("python BooleanFilterPumpHouse.py load and self-test diagnostics complete.")
