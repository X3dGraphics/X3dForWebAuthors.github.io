...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("GeometryPrimitiveNodesWhiteBackground.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("GeometryPrimitiveNodesWhiteBackground.png") \
     .setName("Image") \
    ) \
    .addMeta(meta() \
     .setContent("GeometryPrimitiveNodesWhiteBackgroundReducedQuality.png") \
     .setName("Image") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter02GeometryPrimitives/GeometryPrimitiveNodesWhiteBackground.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter02GeometryPrimitives//GeometryPrimitiveNodesWhiteBackground_RoundTrip.x3d")
