...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter02GeometryPrimitives/GeometryPrimitiveNodesWhiteBackground.x3d',name='identifier'),
...
print('Self-test diagnostics for GeometryPrimitiveNodesWhiteBackground.py:')
...
print("python GeometryPrimitiveNodesWhiteBackground.py load and self-test diagnostics complete.")
