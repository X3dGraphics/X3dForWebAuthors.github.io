...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter02GeometryPrimitives/TextLengthMaxExtent.x3d',name='identifier'),
...
print('Self-test diagnostics for TextLengthMaxExtent.py:')
...
print("python TextLengthMaxExtent.py load and self-test diagnostics complete.")
