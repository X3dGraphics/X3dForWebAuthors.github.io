...
print('Self-test diagnostics for ScalarInterpolatorFishExample.py:')
...
print("python ScalarInterpolatorFishExample.py load and self-test diagnostics complete.")
