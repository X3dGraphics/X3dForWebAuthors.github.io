...
print('Self-test diagnostics for OrientationInterpolatorFishExample.py:')
...
print("python OrientationInterpolatorFishExample.py load and self-test diagnostics complete.")
