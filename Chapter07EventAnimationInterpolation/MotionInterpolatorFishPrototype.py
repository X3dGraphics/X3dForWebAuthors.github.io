...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/MotionInterpolatorFishPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for MotionInterpolatorFishPrototype.py:')
...
print("python MotionInterpolatorFishPrototype.py load and self-test diagnostics complete.")
