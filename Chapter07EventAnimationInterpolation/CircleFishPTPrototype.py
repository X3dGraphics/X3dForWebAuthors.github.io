...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/CircleFishPTPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for CircleFishPTPrototype.py:')
...
print("python CircleFishPTPrototype.py load and self-test diagnostics complete.")
