...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionInterpolator2dExample.x3d',name='identifier'),
    ...
    Transform(DEF='ImageAspectRatio',scale=(1.5,1,1),
      ...
      Shape(
        ...
        appearance=Appearance(
          texture=ImageTexture(DEF='ContactImage',url=["JavaBoardSmileForTheCamera.jpg","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/JavaBoardSmileForTheCamera.jpg"]),
...
print('Self-test diagnostics for PositionInterpolator2dExample.py:')
...
print("python PositionInterpolator2dExample.py load and self-test diagnostics complete.")
