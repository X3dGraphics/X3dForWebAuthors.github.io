...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("ColorInterpolatorFishPrototype.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/ColorInterpolatorFishPrototype.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
       ...
       .addChild(Transform() \
        ...
        .addChild(Transform() \
         ...
         .addChild(ColorInterpolator() \
          .setDEF("ColorValue") \
          .setKey([0,.33,.67,1]) \
          .setKeyValue([.90,.66,.40,.47,.40,.90,.40,.90,.46,.90,.66,.40]) \
         ) \
         .addChild(ROUTE() \
          .setFromField("fraction_changed") \
          .setFromNode("ColorTimer") \
          .setToField("set_fraction") \
          .setToNode("ColorValue") \
         ) \
         .addChild(ROUTE() \
          .setFromField("value_changed") \
          .setFromNode("ColorValue") \
...
# ==================== 
    .addChild(Viewpoint() \
     .setDescription("CircleFish with ColorInterpolator") \
     .setOrientation([0,1,0,1.5708]) \
     .setPosition([2,0,0.5]) \
    ) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation//ColorInterpolatorFishPrototype_RoundTrip.x3d")
