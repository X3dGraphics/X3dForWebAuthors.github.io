...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/CircleFishPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for CircleFishPrototype.py:')
...
print("python CircleFishPrototype.py load and self-test diagnostics complete.")
