...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionInterpolatorPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for PositionInterpolatorPrototype.py:')
...
print("python PositionInterpolatorPrototype.py load and self-test diagnostics complete.")
