...
newModel=X3D(profile='Immersive',version='3.3',
  ...
  Scene=Scene(
    ...
    ProtoInstance(name='CircleFish',
      fieldValue=[
      fieldValue(name='skinTextureUrl',value=["GaribaldiPatch.jpg","https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/GaribaldiPatch.jpg"]),
...
print('Self-test diagnostics for CircleFishPositionInterpolator.py:')
...
print("python CircleFishPositionInterpolator.py load and self-test diagnostics complete.")
