...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/TimeSensorChaining.x3d',name='identifier'),
...
print('Self-test diagnostics for TimeSensorChaining.py:')
...
print("python TimeSensorChaining.py load and self-test diagnostics complete.")
