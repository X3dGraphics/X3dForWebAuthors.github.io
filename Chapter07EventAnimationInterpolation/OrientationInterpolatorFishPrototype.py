...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='OrientationInterpolatorFishPrototype.x3d',name='title'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/KelpForestExhibit/CircleFishPrototype.x3d',name='reference'),
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/OrientationInterpolatorFishPrototype.x3d',name='identifier'),
...
print('Self-test diagnostics for OrientationInterpolatorFishPrototype.py:')
...
print("python OrientationInterpolatorFishPrototype.py load and self-test diagnostics complete.")
