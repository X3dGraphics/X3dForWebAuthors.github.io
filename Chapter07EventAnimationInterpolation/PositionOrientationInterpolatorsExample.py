...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter07EventAnimationInterpolation/PositionOrientationInterpolatorsExample.x3d',name='identifier'),
...
print('Self-test diagnostics for PositionOrientationInterpolatorsExample.py:')
...
print("python PositionOrientationInterpolatorsExample.py load and self-test diagnostics complete.")
