...
print('Self-test diagnostics for CoordinateInterpolator2dExample.py:')
...
print("python CoordinateInterpolator2dExample.py load and self-test diagnostics complete.")
