...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("IndexedTriangleStripSet.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("An example of the use of the IndexedTriangleStripSet node.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/IndexedTriangleStripSet.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
   ...
   .setScene(Scene() \
    .addChild(Viewpoint() \
     .setDescription("IndexedTriangleStripSet view") \
     .setOrientation([0,-1,0,0.07]) \
     .setPosition([-0.06,1.4,11.24]) \
    ) \
    .addChild(Background() \
     .setSkyColor([1,1,1]) \
    ) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals//IndexedTriangleStripSet_RoundTrip.x3d")
