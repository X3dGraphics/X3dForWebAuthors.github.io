...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/TriangleFanSetExample.x3d',name='identifier'),
...
print('Self-test diagnostics for TriangleFanSetExample.py:')
...
print("python TriangleFanSetExample.py load and self-test diagnostics complete.")
