...
newModel=X3D(profile='CADInterchange',version='3.3',
  head=head(
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/IndexedQuadSet.x3d',name='identifier'),
...
print ("python x3d.py load successful for IndexedQuadSet.py")
