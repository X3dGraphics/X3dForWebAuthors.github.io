...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='TriangleFanSet.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/TriangleFanSet.x3d',name='identifier'),
...
print ("python x3d.py load successful for TriangleFanSet.py")
