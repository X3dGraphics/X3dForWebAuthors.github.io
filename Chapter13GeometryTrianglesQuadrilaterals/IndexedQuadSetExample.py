...
newModel=X3D(profile='CADInterchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/IndexedQuadSetExample.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='IndexedQuadSet.x3d'),
    Viewpoint(description='IndexedQuadSet example'),
    Background(skyColor=[(1,1,1)]),
    Transform(
      children=[
      Shape(
        geometry=IndexedQuadSet(ccw=True,colorPerVertex=True,index=[0,1,2,3,4,5,6,7],normalPerVertex=True,solid=False,
...
print('Self-test diagnostics for IndexedQuadSetExample.py:')
...
print("python IndexedQuadSetExample.py load and self-test diagnostics complete.")
