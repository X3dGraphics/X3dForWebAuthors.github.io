...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter13GeometryTrianglesQuadrilaterals/TriangleStripSetExample.x3d',name='identifier'),
...
print('Self-test diagnostics for TriangleStripSetExample.py:')
...
print("python TriangleStripSetExample.py load and self-test diagnostics complete.")
