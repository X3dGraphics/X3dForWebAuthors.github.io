...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='LineSet.x3d',name='reference'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/IndexedLineSet.x3d',name='identifier'),
