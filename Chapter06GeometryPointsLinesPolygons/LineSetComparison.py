...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/LineSetComparison.x3d',name='identifier'),
...
print('Self-test diagnostics for LineSetComparison.py:')
...
print("python LineSetComparison.py load and self-test diagnostics complete.")
