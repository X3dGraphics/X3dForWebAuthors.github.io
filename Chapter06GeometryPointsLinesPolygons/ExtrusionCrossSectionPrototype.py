  ...
  Scene=Scene(
    ...
    ProtoDeclare(appinfo='Shape prototype for Extrusion node that also draws spine line plus oriented scaled cross sections at each spine point',name='ExtrusionCrossSection',
      ...
      ProtoBody=ProtoBody(
        ...
        Script(DEF='CrossSectionScript',url=["ExtrusionCrossSectionPrototype.js","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionCrossSectionPrototype.js"],
          #  local variables 
          field=[
...
print('Self-test diagnostics for ExtrusionCrossSectionPrototype.py:')
...
print("python ExtrusionCrossSectionPrototype.py load and self-test diagnostics complete.")
