...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='LineSetExample.x3d',name='title'),
    ...
    meta(content='IndexedLineSetExample.x3d',name='reference'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/LineSetExample.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(
      ...
      Shape(
        ...
        geometry=LineSet(vertexCount=[19],
      ...
      Shape(
        ...
        geometry=PointSet(
          coord=Coordinate(USE='TurnPoints')))]),
...
print('Self-test diagnostics for LineSetExample.py:')
...
print("python LineSetExample.py load and self-test diagnostics complete.")
