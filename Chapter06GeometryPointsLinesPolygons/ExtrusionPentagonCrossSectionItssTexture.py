...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Naval Postgraduate School',name='contributor'),
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionPentagonCrossSectionItssTexture.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(rotation=(1,0,0,-1.3),translation=(0,2,-9),
      children=[
      Shape(
        geometry=Text(DEF='Title',string=["Comparison of Extrusion Based Structure with Texture Map"],
    ...
    Transform(translation=(-4,0,-4),
      ...
      Shape(
        ...
        appearance=Appearance(
          ...
          texture=ImageTexture(url=["../earth-topo.png","https://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo.png"]))),
    ...
    ExternProtoDeclare(appinfo='Shape prototype for Extrusion node that also draws spine line plus oriented scaled cross sections at each spine point',documentation='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionCrossSectionPrototype.x3d',name='ExtrusionCrossSection',url=["ExtrusionCrossSectionPrototype.x3d#ExtrusionCrossSection","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionCrossSectionPrototype.x3d#ExtrusionCrossSection","ExtrusionCrossSectionPrototype.wrl#ExtrusionCrossSection","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionCrossSectionPrototype.wrl#ExtrusionCrossSection"],
      field=[
    ...
    Transform(translation=(4,0,-4),
      ...
      ProtoInstance(DEF='PentagonExtrusion',name='ExtrusionCrossSection',
        ...
        fieldValue(name='extrusionImageTexture',
          children=[
          ImageTexture(url=["../earth-topo.png","https://X3dGraphics.com/examples/X3dForWebAuthors/earth-topo.png"])]),
...
print('Self-test diagnostics for ExtrusionPentagonCrossSectionItssTexture.py:')
...
print("python ExtrusionPentagonCrossSectionItssTexture.py load and self-test diagnostics complete.")
