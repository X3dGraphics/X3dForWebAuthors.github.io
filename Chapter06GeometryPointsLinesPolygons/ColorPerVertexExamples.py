...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ColorPerVertexExamples.x3d',name='identifier'),
...
print('Self-test diagnostics for ColorPerVertexExamples.py:')
...
print("python ColorPerVertexExamples.py load and self-test diagnostics complete.")
