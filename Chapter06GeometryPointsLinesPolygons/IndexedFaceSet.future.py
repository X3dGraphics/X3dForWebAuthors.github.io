...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("IndexedFaceSet.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Positive-displacement cylinder pump house built using IndexedFaceSet nodes.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/IndexedFaceSet.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
# solid='false' means draw both inside and outside of outer Cylinder 
       .setGeometry(Cylinder(bottom = False, height = 1, solid = False) \
        .setDEF("PistonOuterShell") \
        .setTop(False) \
       ) \
      ) \
     ) \
...
# note that non-uniform scale turns round Cylinders into oval Cylinders 
       .addChild(Transform() \
        ...
        .addChild(Shape() \
         ...
         .setGeometry(Cylinder(height = 1, radius = 0.98) \
          .setDEF("Piston") \
         ) \
        ) \
       ) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons//IndexedFaceSet_RoundTrip.x3d")
