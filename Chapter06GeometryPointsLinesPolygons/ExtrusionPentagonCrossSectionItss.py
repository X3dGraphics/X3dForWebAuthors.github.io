...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionPentagonCrossSectionItss.x3d',name='identifier'),
...
print('Self-test diagnostics for ExtrusionPentagonCrossSectionItss.py:')
...
print("python ExtrusionPentagonCrossSectionItss.py load and self-test diagnostics complete.")
