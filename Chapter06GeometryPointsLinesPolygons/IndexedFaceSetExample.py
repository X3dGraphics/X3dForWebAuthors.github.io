...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/IndexedFaceSetExample.x3d',name='identifier'),
...
print('Self-test diagnostics for IndexedFaceSetExample.py:')
...
print("python IndexedFaceSetExample.py load and self-test diagnostics complete.")
