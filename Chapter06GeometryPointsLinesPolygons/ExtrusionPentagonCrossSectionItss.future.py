...
X3D0 = X3D() \
   ...
   .setHead(head() \
    .addMeta(meta() \
     .setContent("ExtrusionPentagonCrossSectionItss.x3d") \
     .setName("title") \
    ) \
    .addMeta(meta() \
     .setContent("Comparison of Extrusion, ExtrusionCrossSectionPrototype, ExtrusionCrossSectionITSSPrototype.") \
     .setName("description") \
    ) \
    .addMeta(meta() \
    ...
    .addMeta(meta() \
     .setContent("Extrusion, ExtrusionCrossSectionPrototype, ExtrusionCrossSectionITSSPrototype") \
     .setName("subject") \
    ) \
    .addMeta(meta() \
     .setContent("http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons/ExtrusionPentagonCrossSectionItss.x3d") \
     .setName("identifier") \
    ) \
    .addMeta(meta() \
...
# Title 
    .addChild(Transform() \
     ...
     .addChild(Shape() \
      .setGeometry(Text() \
       .setDEF("Title") \
       .setString(["Comparison of Extrusion Based Structures"]) \
...
X3D0.toFileX3D("/x3d-code/www.web3d.org/x3d/content/examples/X3dForWebAuthors/Chapter06GeometryPointsLinesPolygons//ExtrusionPentagonCrossSectionItss_RoundTrip.x3d")
