...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter04ViewingNavigation/AnchorComparison.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    Transform(translation=(0,-2,0),
      children=[
      Anchor(url=["../Chapter03Grouping/CoordinateAxes.x3d","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.x3d","../Chapter03Grouping/CoordinateAxes.wrl","https://X3dGraphics.com/examples/X3dForWebAuthors/Chapter03Grouping/CoordinateAxes.wrl"],
        children=[
...
print('Self-test diagnostics for AnchorComparison.py:')
...
print("python AnchorComparison.py load and self-test diagnostics complete.")
