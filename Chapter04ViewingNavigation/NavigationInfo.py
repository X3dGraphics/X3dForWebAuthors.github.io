...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='NavigationInfo.x3d',name='title'),
    ...
    meta(content='http://X3dGraphics.com/examples/X3dForWebAuthors/Chapter04ViewingNavigation/NavigationInfo.x3d',name='identifier'),
...
print ("python x3d.py load successful for NavigationInfo.py")
